...
class ASP:
    ...
    @classmethod
    def prune_trained_model(cls, model, optimizer, mask_calculator="m4n2_1d",permution = False):
        ...
        cls.init_model_for_pruning(model, mask_calculator=mask_calculator, verbosity=2, whitelist=[torch.nn.Linear, torch.nn.Conv2d], allow_recompute_mask=False, allow_permutation=permution)
