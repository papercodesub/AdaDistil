...
def compute_valid_1d_patterns(m,n):
    ...
    valid_patterns = torch.zeros(len(list2),m)
    for _,i in enumerate(list2):
        for j in i:
            valid_patterns[_][j] = 1
...
def m8n1_1d(mat, density):
    return mn_1d_best(mat, 8, 1)

def m16n1_1d(mat, density):
    return mn_1d_best(mat, 16, 1)
